...
Array(
    ...
    Array('persona','apellidos_persona','input',28,'cumple tamaño minimo','min_size','ADD','apellidos_min_size_ko','Tamaño muy corto. Debe estar entre 3 y 100 caracteres'),
    Array('persona','apellidos_persona','input',29,'cumple tamaño maximo','max_size','ADD','apellidos_max_size_ko','Tamaño muy grande. Debe estar entre 3 y 100 caracteres'),
    Array('persona','apellidos_persona','input',30,'cumple formato','format','ADD','apellidos_format_ko','Formato inválido. Debe contener caracteres alfabéticos (incluidos ñ,á,Á,é,É,í,Í,ó,Ó,ú,Ú,ü,Ü) y solo se permiten los signos punto (.) y guión (-)'),
    Array('persona','apellidos_persona','input',31,'es correcto','valid','ADD',true,'Apellidos persona correcto'),
    //apellidos_persona --> EDIT
    Array('persona','apellidos_persona','input',32,'cumple tamaño minimo','min_size','EDIT','apellidos_min_size_ko','Tamaño muy corto. Debe estar entre 3 y 100 caracteres'),
    Array('persona','apellidos_persona','input',33,'cumple tamaño maximo','max_size','EDIT','apellidos_max_size_ko','Tamaño muy grande. Debe estar entre 3 y 100 caracteres'),
    Array('persona','apellidos_persona','input',34,'cumple formato','format','EDIT','apellidos_format_ko','Formato inválido. Debe contener caracteres alfabéticos (incluidos ñ,á,Á,é,É,í,Í,ó,Ó,ú,Ú,ü,Ü) y solo se permiten los signos punto (.) y guión (-)'),
    Array('persona','apellidos_persona','input',35,'es correcto','valid','EDIT',true,'Apellidos persona correcto'),
    //apellidos_persona --> SEARCH
    Array('persona','apellidos_persona','input',36,'cumple tamaño minimo','min_size','SEARCH','apellidos_min_size_ko','Tamaño muy corto. Debe estar entre 3 y 100 caracteres'),
    Array('persona','apellidos_persona','input',37,'cumple tamaño maximo','max_size','SEARCH','apellidos_max_size_ko','Tamaño muy grande. Debe estar entre 3 y 100 caracteres'),
    Array('persona','apellidos_persona','input',38,'cumple formato','format','SEARCH','apellidos_format_ko','Formato inválido. Debe contener caracteres alfabéticos (incluidos ñ,á,Á,é,É,í,Í,ó,Ó,ú,Ú,ü,Ü) y solo se permiten los signos punto (.) y guión (-)'),
